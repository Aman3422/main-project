...
#             inputError["password"] = "password can not be null"
#         else:
#             if (DataValidator.max_len_20(self.form['password'])):
#                 inputError['password'] = "password is not more than 20 character"
#                 self.form['error'] = True
#
#         if DataValidator.isNull(self.form['dob']):
...
#         if (DataValidator.isNull(self.form['number'])):
#             self.form["error"] = True
#             inputError["number"] = "number can not be null"
#
#         else:
#             if (DataValidator.ismobilecheck(self.form['number'])):
#                 inputError['number'] = "enter correct number"
#                 self.form['error'] = True
#
#         return self.form["error"]
#
...
#         if (DataValidator.isNotNull(self.form["number"])):
#             if (DataValidator.ismobilecheck(self.form['number'])):
#                 inputError['number'] = "number can should in digit and not more than 10 digit"
#                 self.form['error'] = True
#
#         if (DataValidator.isNotNull(self.form['fullName'])):
#             if (DataValidator.isalphacheck(self.form['fullName'])):
#                 inputError['fullName'] = "Name contain only letter"
#                 self.form['error'] = True
#             else:
#                 if (DataValidator.max_len_50(self.form['fullName'])):
#                     inputError['fullName'] = "fullName  should be below 50 character"
#                     self.form['error'] = True
#
#         if (DataValidator.isNotNull(self.form['username'])):
#             if (DataValidator.max_len_20(self.form['username'])):
#                 inputError['username'] = "username is not more than 20 character"
#                 self.form['error'] = True
#             elif (DataValidator.isemail(self.form['username'])):
#                 inputError['username'] = "username is not in email from "
#                 self.form['error'] = True
#
#         if DataValidator.isNotNull(self.form['dob']):
#             if DataValidator.isDate(self.form['dob']):
#                 inputError[
#                     'dob'] = "Incorrect dob format, should be DD-MM-YYYY format and dob should not be in past "
#                 self.form['error'] = True
#
#         if DataValidator.isNotNull(self.form['password']):
#             if DataValidator.max_len_10(self.form['password']):
#                 inputError['password'] = "password is not more than 20"
#                 self.form['error'] = True
#
#         return self.form["error"]
#
...
#                 if (dup.count() > 0):
#                     res["error"] = True
#                     res["message"] = "Employee mail number already exists"
#                 else:
#                     r = self.form_to_model(Employee())
#                     self.get_service().save(r)
#                     if (r != None):
...
#                 return JsonResponse({"data": res, "form": self.form})
#             else:
#                 duplicate = Employee.objects.exclude(id=self.form["id"]).filter(username=self.form["username"])
#                 if (duplicate.count() > 0):
#                     res["error"] = True
