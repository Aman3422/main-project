...
class MedicationCtl(BaseCtl):
    ...
    def input_validation(self):
        ...
        if (DataValidator.isNull(self.form['mid'])):
            self.form["error"] = True
            inputError["mid"] = "category can not be null"
        ...
        if DataValidator.isNull(self.form['dosage']):
            ...
            inputError['dosage'] = "Dosage Should be a Number"
            self.form['error'] = True
        elif (DataValidator.max_len_20(self.form['dosage'])):
            inputError['dosage'] = "Id can should be below 20 digit"
            self.form['error'] = True
    ...
    def input_validation1(self):
        ...
        if DataValidator.isNotNull(self.form['dosage']):
            if (DataValidator.max_len_20(self.form['dosage'])):
                inputError['dosage'] = "dosage can should be below 20 digit"
                self.form['error'] = True
            else:
                if (DataValidator.isnumb(self.form['dosage'])):
                    inputError['dosage'] = "dosage should be integer"
                    self.form['error'] = True
    ...
    def save(self, request, params={}):
        ...
        if (self.input_validation()):
            ...
            if (self.form["id"] > 0):
                ...
                if (dup.count() > 0):
                    res["error"] = True
                    res["message"] = "Medication Name already exists"
                else:
