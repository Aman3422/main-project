...
@Component({
  ...
  styleUrls: ['./compensation-list.component.css']
})
export class CompensationListComponent implements OnInit{
   ...
   * @param service 
   */
  constructor(private router: Router, private service: CompensationService){ }
   ...
   */
  edit(id:any){
    this.router.navigateByUrl("/compensation/" + id);
  }
